...
export default function EditProfileScreen() {
  ...
  const loadProfile = async () => {
    try {
      ...
      // Set date picker values if date exists
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Update current profile in AsyncStorage if this is the current profile
      const currentProfile = await profileService.getCurrentProfile();
      if (currentProfile && currentProfile.id === profileId) {
        await profileService.setCurrentProfile(response.data);
      }
      ...
      <View style={styles.innerContainer}>
        ...
        <View style={styles.allergyInputContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => addAllergy()}
            disabled={updating || !allergyInput.trim()}
          >
